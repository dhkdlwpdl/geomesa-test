...
package org.apache.spark.sql.connector.geomesa.v1
...
import org.apache.spark.sql.connector.geomesa.v1.GeoMesaRelation.{CachedRDD, IndexedRDD, PartitionedIndexedRDD, PartitionedRDD}
import org.locationtech.geomesa.spark.{GeoMesaSpark, SpatialRDD}
import org.locationtech.geomesa.spark.jts.util.WKTUtils
import org.apache.spark.sql.connector.geomesa.v1.GeoMesaRelation.{CachedRDD, IndexedRDD, PartitionedIndexedRDD, PartitionedRDD}
import org.apache.spark.sql.connector.geomesa.v1.GeoMesaSparkSQL.GEOMESA_SQL_FEATURE
...
case class GeoMesaRelation(
  ...
  ) extends BaseRelation with PrunedFilteredScan with LazyLogging with InsertableRelation {
...
//        }
  ...
  override def insert(data: DataFrame, overwrite: Boolean): Unit = {
    data.write.format("geov1").options(params).save()
  }
}
